<template>
  <div class="custom-cursor">
    ...
    <svg class="cursor-trail-svg" ref="trailSvg">
      <polyline :points="trailPoints" stroke="black" stroke-width="4" fill="none" stroke-linecap="round"
...
export default {
  ...
  mounted() {
    ...
    cursorBig.style.transform = 'translate(-100%, -100%)';
...
* {
  ...
  /* Desactiva el cursor predeterminado */
  margin: 0;
  padding: 0;
}
...
.cursor-trail-svg {
  ...
  pointer-events: none;
  z-index: 999;
  /* Un z-index menor que el del cursor */
}

.cursor-trail-line {
  stroke: black;
  /* Estela en color negro */
  stroke-width: 4px;
  /* Grosor de la estela */
