<template>
    <div class="app bg-white max-md:max-w-[768px]">
        <div class="header bg-white p-10 flex text-zinc-600 justify-between sticky top-0 z-10 border-b border-zinc-600 max-md:p-6 max-md:items-center">
        ...
        <div class="trabajos flex pt-20 px-40 pb-20 text-white flex-nowrap items-center gap-64 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            <div class="titular text-[70px] font-normal max-w-[13ch] leading-12 text-zinc-800 max-md:text-[70px] max-md:justify-center">Modelado</div>
            <div class="info flex flex-col gap-6">
                <div class="text max-w-[60ch] text-[16px] leading-10 text-zinc-400 max-md:text-xs">Modelado 3d - Cinema 4d - Blender -
                    Diseño Gráfico</div>
                <div class="text max-w-[60ch] text-[20px] leading-8 text-zinc-600 font-bold max-md:text-sm max-md:max-w-[40ch]">Diferentes trabajos realizados en software 3D 
                    utilizando animación, texturas, iluminaciones y diferentes recursos con Cinema 4d y Blender.
                </div>
            </div>
        </div>
        ...
        <div class="colum flex pt-20 px-40 pb-10 text-white gap-10 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            <div class="info_proyect max-w-[80ch]">
                <div class="info_secondary flex flex-col gap-6 sticky top-32">
                    <div class="text max-w-[60ch] text-[32px] leading-10 text-zinc-800">Trabajos 3D</div>
                    <div class="text text-[16px] leading-6 text-zinc-600 font-normal max-w-[64ch] max-md:text-xs">
                        El video que se muestra arriba para un trabajo libre y de aprendizaje de Blender, esta realizado con
                        el cometido de aprender a animar y probrar las diferentes herramientas creativas y posibilidades del programa
                        pudiendo crear un efecto de letras que se van inflando como glovos a raiz que el tiempo va pasando.
                        <br>
                        <br>
                        Las fotos de a continuación pertenecen a un trabajo para la asignatura de 3D en la que se crea un bodegon creativo, realizando
                        diferentes figuras y formas geometricas a las que les añadiremos con el plugin de Octane Render diferentes materiales, iluminaciones y camaras más profesionales
                        para darle ese atractivo y esos detalles tan visuales. Pruebas de diferentes iluminaciones y diferentes texturas en los elementos cambiando las camaras y los ángulos.
                    </div>
                </div>
            </div>
            <div class="fotografias flex flex-col gap-6">
                <img class="image_rect drop-shadow-xl" src="/img/render3d2.png" alt="">
                <img class="image_rect drop-shadow-xl" src="/img/render3d.png" alt="">
            </div>
        </div>
        ...
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            <div class="text max-w-[60ch] text-[32px] leading-10 text-zinc-800">Loop</div>
            <div class="text max-w-[60ch] text-[16px] text-zinc-600 font-bold max-md:text-xs">Creación de un loop animado 3d para probar las diferentes utilidades de animación
                y frames de la aplicación, aplicando materiales e iluminación.
            </div>
            <div class="video flex pt-10 text-white flex-nowrap items-center gap-64 justify-center">
            <video class="video w-full h-full border border-zinc-600 drop-shadow-xl" loop autoplay controls>
        ...
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            <div class="text max-w-[60ch] text-[32px] leading-10 text-zinc-800 pb-10">Ciudad</div>
            <div class="text max-w-[60ch] text-[16px] leading-6 text-zinc-600 font-bold pb-12 max-md:text-xs">Creación de una maqueta sencilla de una
        ...
        <div class="trabajos flex pt-10 pl-40 pr-40 pb-10 text-zinc-600 flex-col gap-10 justify-center items-center max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            ...
            <div class="programas flex flex-col items-center">
                <div class="three_programas flex gap-10">
                    <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px] max-md:max-h-[29px]" src="/img/blender.png" alt="">
                    <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px] max-md:max-h-[29px]" src="/img/Cinema4d.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="foter bg-white p-10 flex text-zinc-600 justify-between sticky top-0 border-t border-zinc-600 max-md:p-6">
