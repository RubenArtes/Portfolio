<template>
    <div id="inicio" class="app bg-black font-['SFUIDisplay-Regular']">
            ...
            <div class="menucito fixed top-0 right-0 h-full w-[860px] max-sm:w-full max-[1920px]:w-[700px] bg-zinc-600 shadow-lg z-50 p-8 max-sm:p-6 transform transition-transform backdrop-filter backdrop-blur-md bg-opacity-30 text-black dark:text-white"
                ...
                <ul class="pt-12 flex flex-col justify-between h-full">
                    <div class="columna1 flex-grow">
                        ...
                        <li>
                            <a href="/FotografiasProvoke#contacto"
                                class="email max-sm:text-[22px] max-sm:leading-8 text-black dark:text-white underline-offset-1 after:bg-current after:absolute after:h-[2px] after:w-0 after:bottom-[5px] after:left-0 hover:after:w-full after:transition-all after:duration-500 cursor-pointer text-[22px] max-[1920px]:text-[20px] self-center place-self-start flex gap-2 max-lg:text-xs">
                                Contacto
                            </a>
                        </li>
        ...
        <div class="div1 max-sm:hidden pt-2 border border-zinc-200 border-t-0 pt-24 border-l-0 border-r-0 border-b-0">
            <div
                class="info_secondary max-[1500px]:px-24 max-[1500px]:pt-12 max-[1500px]:pb-32 z-20 bg-black max-[1920px]:px-[12rem] px-32 pb-44 place-items-start pt-32 flex flex-col gap-6 max-sm:px-12 top-32 max-[1500px]:gap-12">
                <div
                ...
                <div
                    ...
                    FOTOGRAFÍAS - FEBRERO 2023
                    <br>
                    ASIGNATURA FOTOGRAFÍA - ABSTRACCIÓN
                </div>
                <div
        ...
        <div class="div1 max-sm:hidden pt-32 px-12 grid grid-cols-3 gap-[11px]">
            ...
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke.jpg"
                alt="" />
            <NuxtImg class="image_grid invisible" src="/img/provoke.jpg" alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke3.jpg"
                alt="" />
            ...
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke2.jpg"
                alt="" />
            <NuxtImg class="image_grid rotate-90 invisible" src="/img/provoke.jpg" alt="" />
            ...
            <NuxtImg class="image_grid invisible" src="/img/provoke4.jpg" alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke5.jpg"
                alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke6.jpg"
                alt="" />
            ...
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke4.jpg"
                alt="" />
            ...
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke7.jpg"
                alt="" />
            <NuxtImg class="image_grid invisible" src="/img/provoke8.jpg" alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke9.jpg"
                alt="" />
            ...
            <NuxtImg class="image_grid invisible" src="/img/provoke8.jpg" alt="" />
            <NuxtImg class="image_grid invisible" src="/img/provoke8.jpg" alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke8.jpg"
                alt="" />
            ...
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300" src="/img/provoke10.jpg"
                alt="" />
            <NuxtImg class="image_grid invisible" src="/img/provoke11.jpg" alt="" />
            <NuxtImg class="image_grid invisible" src="/img/provoke12.jpg" alt="" />

            <div
                class="text max-w-[60ch] pt-[11px] text-[14px] font-['Neue-Italic'] animate-pulse text-start uppercase text-white max-xl:leading-2 max-xl:text-xs max-[1280px]:text-center max-[1280px]:justify-center">
                [ LUCES ABSTRACTAS / PROVOKE ]</div>
            <div
                class="text max-w-[60ch] pt-[11px] text-[14px] invisible font-['Neue-Italic'] animate-pulse text-start uppercase text-white max-xl:leading-2 max-xl:text-xs max-[1280px]:text-center max-[1280px]:justify-center">
                [ FOTOGRAFÍA / PROVOKE ]</div>
            <div
            ...
            <NuxtImg class="image_grid pr-12 invisible" src="/img/provoke12.jpg" alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300 pr-12" src="/img/provoke11.jpg"
                alt="" />
            <NuxtImg class="image_grid hover:scale-105 transition-transform duration-300 pl-12" src="/img/provoke12.jpg"
                alt="" />
