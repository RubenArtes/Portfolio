<template>
    <div class="app bg-[#FEE8D4]">
        ...
        <div
            ...
            <div
                class="titular text-[70px] font-bold max-w-[13ch] leading-12 animate-pulse leading-12 bg-gradient-to-r bg-clip-text text-transparent from-[#F3536D] via-[#FFB047] to-[#FBCE37] animate-text max-xl:text-[70px] max-xl:justify-center">
                Packaging</div>
            <div class="info flex flex-col gap-6">
                <div class="text max-w-[60ch] text-[16px] leading-10 text-zinc-500 max-xl:leading-2 max-xl:text-xs">Diseño
        ...
        <div
            class="trabajos flex pt-20 px-40 text-white items-start flex-nowrap gap-40 justify-center max-xl:pt-16 max-xl:px-10 max-xl:flex-col max-xl:justify-center max-xl:gap-10 max-xl:items-center max-xl:text-center">
        ...
        <div
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-500 font-bold pb-12 max-xl:text-xs">Muestra del packaging
                final con todas
        ...
        <div
            ...
            <div class="div text-zinc-600 px-64 text-right text-xs m-0 pb-8">Etiquetas de información e inferiores del packagin</div>
        ...
        <div class="grid grid-cols-3 gap-2 px-64 pb-32 max-xl:grid-cols-1 max-xl:px-10 max-xl:pt-10">
            <div class="div text-zinc-600 text-center text-xs m-0 pb-14">Render 3D con iluminación y colores
                <br>
