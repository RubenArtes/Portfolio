    ...
    <div class="app bg-black">
        ...
        <div class="video flex pt-20 px-64 pb-20 text-white flex-nowrap items-center gap-64 justify-center">
            <video width="1240" height="788" loop autoplay controls>
                <source src="/img/Comp 1_2.mp4" type="video/mp4">
        ...
        <div class="colum flex pt-20 px-64 pb-10 text-white gap-32 justify-center">
            <div class="info_proyect max-w-[80ch]">
                <div class="info_secondary flex flex-col gap-6">
                    <div class="text max-w-[60ch] text-[32px] leading-10 text-white">Tres packaging saludables</div>
        ...
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10">
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12">Muestra del packaging final con todas
                sus caras embolventes viendo como el patrón continua y se va formando por todo el packaging.
                <br><br> <a class="type text-[#c13d56]">Frambuesa liofilizada</a> - <a
                    class="type text-[#d37a24]">Garzbanzos Spicy</a> - <a class="type text-[#eec331]">Snacks de Verduras</a>
            </div>

            <div class="grid grid-cols-1">
                <img class="image_grid w-full h-full pb-6 border-b" src="/img/troquel22.png" alt="">
                <img class="image_grid w-full h-full pt-6 pb-6 border-b" src="/img/troquel222.png" alt="">
                <img class="image_grid w-full h-full pt-6" src="/img/troquel223.png" alt="">
            </div>
