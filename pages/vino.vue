    ...
    <div class="app bg-[#EAEEF6]">
        <div class="header bg-[#C9D2E8] p-10 flex text-white justify-between sticky top-0 z-10 max-md:p-6 max-md:items-center">
            ...
            <div class="email text-lg flex gap-2 items-center max-md:text-xs">ruben.maldonado.graphic@gmail.com
                <NuxtLink to="/">
                    <img class="vector max-md:max-w-[15px]" src="/img/Vector-11.svg">
                </NuxtLink>
            </div>
        </div>
        <div class="trabajos flex pt-20 px-40 pb-10 text-white flex-nowrap items-center gap-64 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            <div class="titular text-[70px] font-normal max-w-[13ch] leading-12 text-[#311568] max-md:text-[70px] max-md:justify-center">Packaging</div>
            <div class="info flex flex-col gap-6">
                <div class="text max-w-[60ch] text-[16px] leading-10 text-[#AFBAD4] max-md:leading-2 max-md:text-xs">Diseño Prua - Packaging - Marca -
                    Diseño Gráfico</div>
                <div class="text max-w-[60ch] text-[20px] leading-8 text-zinc-600 font-bold max-md:text-sm max-md:max-w-[40ch]">Este trabajo consiste en
        ...
        <div class="video flex px-64 text-white flex-nowrap items-center gap-64 justify-center max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
        ...
        <div class="colum flex pt-20 px-64 pb-10 text-white gap-32 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            <div class="info_proyect max-w-[80ch]">
                <div class="info_secondary flex flex-col gap-6 sticky top-32">
                    ...
                    <div class="text text-[16px] leading-6 text-zinc-600 font-normal max-w-[64ch] max-md:text-xs">
                        ...
                        calidad.
                        <br><br>
                        Una vez desarrollado durante años el vino clarete se ha pensado el producir otras elaboraciones
                        asemejando la calidad y el cuidado del vino y con la idea de crear productos gourmets. Estos
                        productos serán el queso de cabra y la mermelada natural, haciendo de estos unos productos con una
                        elaboración muy cuidada y artesanal con cero idea de producción industrial.
                        Esta marca tendrá como nombre Prau, productor y exportador de La Rioja con un concepto de pasión por
                        la tierra y el campo.
                        <br><br>
                        El nombre de Prau nace con la idea de utilizar el campo y la tierra y combinarlo con el dialecto
                        riojano, por lo que Prau - Del dialecto de Rioja, riojano, sirve para denominar al prado, al campo
                        la tierra en general.
                        <br><br>
                        Entra en consonancia con los valores de esta marca, ya que representa esa pasión por la tierra y por
            ...
            <div class="fotografias flex flex-col h-min">
                <img class="image_rect rounded-xl w-[550px]" src="/img/vino3.png" alt="">
                <img class="image_rect rounded-xl w-[550px]" src="/img/vino2.png" alt="">
                <img class="image_rect rounded-xl w-[550px]" src="/img/vino1.png" alt="">
            </div>
        </div>
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-600 font-bold pb-12 max-md:text-xs">Etiqueta para el apartado de mermelada,
        ...
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-600 font-bold pb-12 max-md:text-xs">Etiqueta para el apartado de vino,
                muestra de la etiqueta y como se integra
        ...
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-600 font-bold pb-12 max-md:text-xs">Etiqueta para el apartado de queso,
        ...
        <div class="images pt-6 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            <div class="text max-w-[60ch] text-[32px] leading-10 text-[#311568]">Ilustraciones</div>
            <div class="text max-w-[60ch] text-[16px] text-zinc-600 font-bold max-md:text-xs">Ilustraciones creadas para cada uno de los
                packaging
        ...
        <div class="trabajos flex pt-10 pl-40 pr-40 pb-20 text-zinc-600 flex-col gap-10 justify-center items-center max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            ...
            <div class="programas flex flex-col items-center">
                <div class="three_programas flex gap-10">
                    <img class="image_logo w-[40px] rounded-lg opacity-80 hover:opacity-100 max-md:max-w-[30px] max-md:max-h-[29px]" src="/img/Procreate.png" alt="">
                    <img class="image_logo w-[40px] rounded-lg opacity-80 hover:opacity-100 max-md:max-w-[30px]" src="/img/Figmazinc.svg" alt="">
                    <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px]" src="/img/Illustratorzinc.svg" alt="">
                    <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px]" src="/img/InDesignzinc.svg" alt="">
                    <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px]" src="/img/Photoshopzinc.svg" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="foter bg-[#C9D2E8] p-10 flex text-white justify-between sticky top-0 max-md:p-6">
