<template>
  <div class="app bg-black">
    ...
    <div class="trabajos flex pt-20 px-40 pb-20 text-white flex-nowrap items-center gap-64 justify-center">
      <div class="titular text-[70px] font-normal max-w-[13ch] leading-12">Fotografías</div>
      <div class="info flex flex-col gap-6">
        <div class="text max-w-[60ch] text-[16px] leading-10 text-zinc-200">Fotografías - Ediciones - Retratos -
          Paisajes - Social -
          Diseño Gráfico</div>
        <div class="text max-w-[60ch] text-[20px] leading-8 text-zinc-400 font-bold">Recopilación de fotografías y
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10">
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold">Fanzine sobre el Subterraneo de Madrid, conteniendo
              diferentes temas como este, la composición de sus lugares, el tema social y las personas y la arquitectura.
            </div>
            <div class="video flex text-white flex-nowrap items-center gap-64 justify-center">
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10">
      ...
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12"> Fotografías en estudio de bodegones
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10">
      ...
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12"> Fotografías realizadas con temática de la
        revista Japonesa
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10">
      ...
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12"> Fotografías de modelo en exterior a dos modelos
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10">
      ...
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12"> Fotografías en estudio y esterior de
        retrato
    ...
    <div class="trabajos flex pt-10 pl-40 pr-40 pb-20 text-zinc-300 flex-col gap-10 justify-center items-center">
      ...
      <div class="programas flex flex-col items-center">
        <div class="three_programas flex gap-10">
          <img class="image_logo w-[40px] opacity-80 hover:opacity-100" src="/img/Lightroom.svg" alt="">
          <img class="image_logo w-[40px] opacity-80 hover:opacity-100" src="/img/Photoshop.svg" alt="">
        </div>
      </div>
    </div>
