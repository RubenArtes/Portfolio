<template>
  <div class="app bg-black max-md:max-w-[768px]">
    ...
    <div class="trabajos flex pt-20 px-40 pb-20 text-white flex-nowrap items-center gap-64 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
      <div class="titular text-[70px] font-normal max-w-[13ch] leading-12 max-md:text-[55px] max-md:justify-center">Fotografías</div>
      <div class="info flex flex-col gap-6">
        <div class="text max-w-[60ch] text-[16px] leading-10 text-zinc-200 max-md:text-xs">Fotografías - Ediciones - Retratos -
          Paisajes - Social -
          Diseño Gráfico</div>
        <div class="text max-w-[60ch] text-[20px] leading-8 text-zinc-400 font-bold max-md:text-sm max-md:max-w-[40ch]">Recopilación de fotografías y
    ...
    <div class="video flex px-64 pb-20 text-white flex-nowrap items-center gap-64 justify-center max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
    ...
    <div class="colum flex pt-20 px-40 pb-10 text-white gap-32 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            <div class="text max-w-[60ch] text-[32px] leading-10 text-white">Fanzine Metro Madrid</div>
            <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold max-md:text-xs">Fanzine sobre el Subterraneo de Madrid, conteniendo
              diferentes temas como este, la composición de sus lugares, el tema social y las personas y la arquitectura.
            </div>
            <div class="video flex text-white flex-nowrap items-center gap-64 justify-center max-md:pt-10">
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
      <div class="text max-w-[60ch] text-[32px] leading-10 text-white">Fotografías de bodegones</div>
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12 max-md:text-xs"> Fotografías en estudio de bodegones
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
      ...
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12 max-md:text-xs"> Fotografías realizadas con temática de la
        revista Japonesa
        Provoke, los cuales utilizan mucho el grano en sus fotografías, el alto contraste, la subexposición y la
        sobrexposición, además de elementos abstractos
        o poco usuales.
      </div>

      <div class="grid grid-cols-3 gap-4 max-md:grid-cols-1">

        <img class="image_grid w-full h-full pb-2" src="/img/provoke2.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke10.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke11.jpg" alt="">

        <img class="image_grid w-full h-full pb-2" src="/img/provoke.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke9.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke8.jpg" alt="">

        <img class="image_grid w-full h-full pb-2" src="/img/provoke6.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke7.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke3.jpg" alt="">

        <img class="image_grid w-full h-full pb-2" src="/img/provoke4.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke5.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/provoke12.jpg" alt="">
    ...
    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
      <div class="text max-w-[60ch] text-[32px] leading-10 text-white">Fotografías de modelo</div>
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12 max-md:text-xs"> Fotografías de modelo en exterior a dos modelos
        de clase, realizando fotos con iluminación natural.
      </div>

      <div class="grid grid-cols-3 gap-4 max-md:grid-cols-1">

        <img class="image_grid w-full h-full pb-2" src="/img/modelo.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/modelo2.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/modelo3.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/modelo4.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/modelo5.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/modelo6.jpg" alt="">

      </div>
    </div>

    <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
      <div class="text max-w-[60ch] text-[32px] leading-10 text-white">Fotografías de retrato</div>
      <div class="text max-w-[60ch] text-[16px] text-zinc-400 font-bold pb-12 max-md:text-xs"> Fotografías en estudio y esterior de
        retrato
        a diferentes compañeras en la universidad. Las dos primeras fotografías de clave alta y las 4 siguientes en clave
        baja. Utilización de focos y flashes.
      </div>

      <div class="grid grid-cols-3 gap-4 max-md:grid-cols-1">

        <img class="image_grid w-full h-full pb-2" src="/img/estudio2.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/estudio5.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/estudio4.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/estudio3.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/estudio6.jpg" alt="">
        <img class="image_grid w-full h-full pb-2" src="/img/estudio7.jpg" alt="">
    ...
    <div class="trabajos flex pt-32 pl-40 pr-40 pb-20 text-zinc-300 flex-col gap-10 justify-center items-center max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
      ...
      <div class="programas flex flex-col items-center">
        <div class="three_programas flex gap-10">
          <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px]" src="/img/Lightroom.svg" alt="">
          <img class="image_logo w-[40px] opacity-80 hover:opacity-100 max-md:max-w-[30px]" src="/img/Photoshop.svg" alt="">
        </div>
      </div>
    </div>
