<template class="bg-zinc-800">
    ...
    <div id="header" class="font-['SFUIDisplay-Light'] bg-zinc-800"
        ...
        <div class="trabajos bg-zinc-800">
            <div class="categoria1 mx-20 max-[1920px]:mx-20 max-sm:mx-8 pt-20 pb-20 bg-zinc-800 flex self-start border border-l-0 border-r-0 max-sm:flex-col max-sm:pb-8 max-sm:pt-8">
                <p
                    class="titulo bg-zinc-800 w-[1220px] self-start text-white leading-none text-[40px] gap-2 max-lg:text-xs max-sm:text-[30px] max-sm:leading-6 max-sm:pb-6">
                    Fotografía
                </p>
        ...
        <div id="contacto" class="informacion pt-[300px] pb-64 bg-zinc-800">
            <div class="about bg-black">
                <div class="correo grid grid-cols-2 text-white bg-zinc-800">
                    <div
                        class="caja2 text-left px-20  font-['Neue'] text-[170px] pt-12 pb-12 leading-[10rem] cursor-pointer text-white transition-colors duration-300 animate-pulse">
                        Correo
                    </div>
                    <div
            ...
            <div class="about bg-zinc-800 pt-2 relative">
