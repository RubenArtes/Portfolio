<template>
  <div class="app bg-white font-['SFUIDisplay-Light'] w-screen">
    ...
    <div
      ...
      <div class="titular_flex items-center text-center flex gap-6 flex-col max-lg:items-center max-lg:flex">
        <div
          class="animate-text max-w-[80ch] flex items-center text-center text-zinc-500 text-base max-lg:justify-center max-[2000px]:text-[12px] max-[2000px]:max-w-[200ch] max-[2000px]:px-28 max-[510px]:px-16">
        ...
        <div
          class="text flex text-center justify-items-center font-['SFUIDisplay-Regular'] text-zinc-800 text-base italic max-[510px]:px-20 max-[510px]:pt-8">
          «Diseñar es pensar en hacerlo visual.» — Saul Bass</div>
      </div>

    </div>
    <div class="accede flex px-64 text-center justify-center text-zinc-600 pb-10 text-xs max-[720px]:px-4 max-[510px]:px-20 max-[510px]:pb-12">«Pasa el ratón por encima para
      ...
      <div class="grid grid-cols-4 w-screen max-[1380px]:grid-cols-3 max-[1080px]:grid-cols-2 max-[760px]:grid-cols-1">
        <NuxtLink to="/packaging">
          <div
            ...
            <div
              class="text text-[20px] leading-[5rem] pb-96 font-['SFUIDisplay-Light'] font-normal tracking-normal flex flex-col items-left justify-center max-[760px]:text-[14px] max-[760px]:pb-72 max-[760px]:order-0 max-[760px]:text-center max-[760px]:pb-2 max-[760px]:leading-[1rem]">
              PACKAGING</div>
            <div
              class="text text-[300px] font-['SFUIDisplay-Regular'] font-bold tracking-normal flex flex-col items-center justify-center max-[2260px]:text-[250px] max-[760px]:text-[120px] max-[760px]:order-2">
              1</div>
          </div>
        </NuxtLink>
        <NuxtLink to="/Prau">
          <div
            ...
            <div
              ...
              VINOS <br> PRAU</div>
            <div
              class="text text-[20px] leading-[5rem] pb-96 font-['SFUIDisplay-Light'] font-normal tracking-normal flex flex-col items-left justify-center max-[760px]:text-[14px] max-[760px]:pb-72 max-[760px]:text-center max-[760px]:pb-2 max-[760px]:leading-[1rem]">
              PACKAGING</div>
            <div
              class="text text-[300px] font-['SFUIDisplay-Regular'] font-bold tracking-normal flex flex-col items-center justify-center max-[2260px]:text-[250px] max-[760px]:text-[120px]">
              2</div>
          </div>
        </NuxtLink>
        ...
        <div
          class="trabajo1 border border-solid px-20 py-30 flex flex-col justify-center hover:bg-[url('/img/NuevaCategoria9.png')] bg-cover bg-center max-[1840px]:px-16 max-[760px]:px-8 max-[760px]:py-0 max-[760px]:max-h-[800px] max-[760px]:pt-12 max-[760px]:pb-4 max-[760px]:bg-[url('/img/NuevaCategoria9.png')] max-[760px]:text-black">
          <div
            class="text text-[50px] leading-[4rem] pt-24 font-['Domaine-Display'] font-bold tracking-normal flex flex-col items-left justify-center max-[2260px]:text-[40px] max-[2260px]:leading-[3rem] max-[1840px]:text-[32px] max-[760px]:text-[26px] max-[760px]:pt-2 max-[760px]:leading-[2rem] max-[760px]:text-[55px] max-[760px]:leading-[3.5rem] max-[760px]:text-center ">
  ...
  <div class="flex pt-32 px-40 pb-40 text-black flex-col gap-20 border border-b-1 items-center justify-center max-lg:px-10 max-lg:flex-col max-lg:justify-items-center max-lg:gap-14">
  ...
  <div
    class="trabajos flex pt-32 pl-40 pr-40 pb-40 border border-b-1 text-black flex-nowrap gap-60 justify-center max-lg:pt-6 max-lg:px-10 max-lg:flex-col max-lg:justify-items-center max-lg:gap-20">
    ...
    <div class="servicios_ofrecidos flex flex-col gap-6">
      ...
      <div class="servicio flex flex-col gap-6">
        ...
        <div class="text max-w-[60ch] font-normal text-[16px] text-zinc-400">Conocimientos altos en <a
  ...
  <div
    class="trabajos flex pt-32 pl-40 pr-40 pb-20 text-black flex-nowrap gap-60 justify-center max-lg:pt-6 max-lg:px-10 max-lg:flex-col max-lg:justify-items-center max-lg:gap-20">
    <div class="sticky_menu">
      <div
    ...
    <div class="servicios_ofrecidos flex flex-col gap-6">
      <div class="servicio flex flex-col gap-6">
        <div class="text max-w-[60ch] font-normal text-[16px] text-zinc-600">→ Ganador de concurso de carteles para <a
            class="bold font-bold text-black">Villaluenga de la Sagra</a> - Cartel para el libro de las fiestas
          <br> → Creación de cartelería para página web y físico y creación de pictogramas para empresa <a
            class="bold font-bold text-black">Neumáticos por Poco.</a> <a class="bold text-xs text-black">- (6
            meses)</a>
          <br> → Renovación y creación de marca para la empresa <a class="bold font-bold text-black">Motor
            76.</a> <a class="bold text-xs text-black">- (1 mes)</a>
          <br> → Creación de ilustraciones para portadas de noticias en <a class="bold font-bold text-black">Ecos
            Castilla La Mancha.</a> <a class="bold text-xs text-black">- (2 meses)</a>
  ...
  <div class="servicios_ofrecidos flex flex-col gap-6">
    <div class="servicio flex flex-col gap-6">
      <div class="text max-w-[60ch] font-normal text-[16px] text-zinc-600">
        <br><a class="bold font-bold text-black"> → Bachillerato Artístico </a> en IES El Greco Toledo.
        <br><a class="bold font-bold text-black"> → Grado Superior de Ilustración</a> en la Escuela de Artes de
        Toledo.
        <br><a class="bold font-bold text-black"> → 3 Cursos de Grado Universitario de Diseño Gráfico </a> en la
        Escuela Superior de Diseño de Madrid.
        <br><a class="bold font-bold text-black"> → Curso extracurricular de 2 años de Arte y Pintura </a> en
        Villaluenga de la Sagra.
        <br><a class="bold font-bold text-black"> → Cursos de Domestika:</a> "Ilustración Digital con Procreate",
...
<div
  class="links_rrss pt-32 px-80 pb-32 text-black justify-center flex flex-row gap-60 max-lg:pt-6 max-lg:px-10 max-lg:flex-col max-lg:justify-items-center max-lg:gap-20 max-lg:flex max-lg:justify-center">
...
<div class="foter bg-white p-10 flex text-black justify-between sticky top-0 max-lg:p-6 border border-t-1">
