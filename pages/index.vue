      ...
      <div class="grid grid-cols-4 w-screen max-[1380px]:grid-cols-3 max-[1080px]:grid-cols-2 max-[760px]:grid-cols-1">
        <NuxtLink to="/packaging">
          <div
            ...
            <div
              class="text text-[20px] leading-[5rem] pb-96 font-['SFUIDisplay-Light'] font-normal tracking-normal flex flex-col items-left justify-center max-[760px]:text-[14px] max-[760px]:pb-72 max-[760px]:order-1 max-[760px]:text-center max-[760px]:pb-2 max-[760px]:leading-[1rem]">
              PACKAGING</div>
            <div
              class="text text-[300px] font-['SFUIDisplay-Regular'] font-bold tracking-normal flex flex-col items-center justify-center max-[2260px]:text-[250px] max-[760px]:text-[120px] max-[760px]:order-4">
              1</div>
          </div>
        </NuxtLink>
        <NuxtLink to="/Prau">
