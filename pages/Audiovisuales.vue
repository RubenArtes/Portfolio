<template>
    <div class="app bg-white font-['SFUIDisplay-Regular']">
        ...
        <div
            ...
            <video class="video border border-zinc-600 drop-shadow-xl" width="1240" height="788" loop autoplay>
        ...
        <div
            class="accede2 flex px-64 text-center justify-center text-zinc-600 pb-32 text-xs max-[720px]:px-4 max-sm:px-20 max-sm:pb-12 max-sm:hidden">
            «Pasa el ratón por encima para descubrir el trabajo y clickea en uno para
            saber más de el»
        </div>

        <div
            class="accede2 hidden max-sm:flex px-64 text-center justify-center text-zinc-600 pb-16 text-xs max-[720px]:px-4 max-sm:px-20 max-sm:pb-12 max-sm:pt-2">
