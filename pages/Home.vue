<template>
    <div class="app bg-white font-['SFUIDisplay-Light']">
        ...
        <div
            ...
            <div
                class="titular_flex pt-12 flex flex-col max-lg:items-center max-lg:flex max-[2000px]:px-0 max-[510px]:pt-2">
                <div
        ...
        <div
            class="accede flex px-64 text-center justify-center text-zinc-600 pb-16 text-xs max-[720px]:px-4 max-[510px]:px-20 max-[510px]:pb-12">
        ...
        <div class="trabajos justify-center w-auto">
            <div
                ...
                <div
                    ...
                    <div class=" bg-red-700 text-white justify-center content-center text-[12px]">PÁGINAS NUEVAS -
                        PÁGINAS NUEVAS - PÁGINAS NUEVAS
                    </div>
                    <div class=" bg-red-700 text-white justify-center content-center text-[12px] max-[510px]:hidden">
                        PÁGINAS NUEVAS - PÁGINAS NUEVAS - PÁGINAS NUEVAS
                    </div>
                    <div class=" bg-red-700 text-white justify-center content-center text-[12px] hidden">PÁGINAS NUEVAS
                        - PÁGINAS NUEVAS - PÁGINAS NUEVAS
                    </div>
        ...
        <div
            ...
            <div
                ...
                <div class="three_programas flex justify-center gap-40 max-lg:grid-cols-3 max-lg:grid max-lg:gap-8">
                    <img class="image_logo w-[50px] h-[49px] max-lg:max-w-[50px] max-lg:max-h-[49px]"
            ...
            <div class="servicios_ofrecidos flex flex-col gap-6 pt-6">
                <div class="servicio flex flex-col gap-6">
                    <div class="text max-w-[60ch] font-normal text-[16px] text-zinc-600">
                        ...
                        <a class="bold animate-pulse font-bold text-black"
                            href="https://www.garridogallery.com/">Garrido
                            Gallery</a>
