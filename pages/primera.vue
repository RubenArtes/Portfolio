<template>
    <div class="app bg-white font-['SFUIDisplay-Light'] ">
      ...
      <div
        class="accede flex px-64 text-center justify-center text-zinc-600 pb-10 text-xs max-[720px]:px-4 max-[510px]:px-20 max-[510px]:pb-12">
        «Pasa el ratón por encima para
