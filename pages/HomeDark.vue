<template>
  <div class="app bg-black font-['SFUIDisplay-Light'] ">
    ...
    <div
      class="trabajos  z-0 px-64 flex pt-16 pb-32 text-white flex-col items-left gap-10 items-left max-lg:pt-16 max-lg:px-10 max-lg:flex-col max-lg:justify-center max-lg:gap-2 max-lg:justify-items-center max-[1080px]:px-20 max-[1080px]:pb-32 max-[720px]:px-4 max-[510px]:px-2 max-[510px]:pt-8 max-[510px]:pb-16">
  ...
  <div
    class="trabajos flex pt-32 pl-40 pr-40 pb-20 text-white flex-nowrap gap-60 justify-center max-lg:pt-20 max-lg:px-10 max-lg:flex-col max-lg:justify-items-center max-lg:gap-20">
    <div class="sticky_menu">
      <div
...
<div
  class="links_rrss pt-64 px-80 pb-32 text-white justify-center flex gap-12 flex-row max-lg:pt-6 max-lg:px-10 max-lg:flex-col max-lg:justify-items-center max-lg:gap-20 max-lg:flex max-lg:justify-center">
  ...
  <div class="links flex pl-12 flex-col gap-2 max-lg:justify-center">
