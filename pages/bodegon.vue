<template>
    <div class="app bg-white">
        ...
        <div
            ...
            <div
                class="titular text-[100px] font-bold max-w-[13ch] leading-12 animate-pulse leading-12 bg-gradient-to-r bg-clip-text text-transparent from-[#e82b2b] via-[#eebf06] to-[#fff385] max-xl:text-[45px] max-xl:justify-center">
                Bodegon</div>
        ...
        <div
            ...
            <div class="text max-w-[55ch] text-[16px] text-zinc-400 font-bold pb-12 max-xl:text-xs"> Fotografías en estudio de bodegones
          con diferentes temáticas. Utilización de focos y flashes.
                <br>
                <br>
                <div class="fecha pb-10 text-xs">3 curso ESD Madrid</div>
            </div>
