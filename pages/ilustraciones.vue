<template>
    <div class="app bg-white">
        ...
        <div class="trabajos flex pt-20 px-40 pb-20 text-black flex-nowrap items-center gap-64 justify-center">
            <div class="titular text-[70px] font-normal max-w-[13ch] leading-12 text-[#D61E0A]">Ilustraciones</div>
            <div class="info flex flex-col gap-6">
                <div class="text max-w-[60ch] text-[16px] leading-10 text-zinc-400">Dibujos - Lettering - Ilustraciones -
                    Carteles -
                    Pegatinas</div>
                <div class="text max-w-[60ch] text-[20px] leading-8 text-zinc-600 font-bold">Recopilatorio de mis ilustraciones, carteles ilustrados,
