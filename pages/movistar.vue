<template>
    <div class="app bg-[#eb595a] max-md:max-w-[768px]">
        <div class="header bg-[#DC5051] p-10 flex text-white justify-between sticky top-0 z-10 max-md:p-6 max-md:items-center">
        ...
        <div class="trabajos flex pt-20 px-40 pb-20 text-white flex-nowrap items-center gap-64 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            <div class="titular text-[70px] font-normal max-w-[13ch] leading-12 max-md:text-[70px] max-md:justify-center">Video</div>
            <div class="info flex flex-col gap-6">
                <div class="text max-w-[60ch] text-[16px] leading-10 text-zinc-100 max-md:text-xs">Audiovisuales - Movistar - Identidad -
                    After Effects</div>
                <div class="text max-w-[60ch] text-[20px] leading-8 text-zinc-100 font-bold max-md:text-sm max-md:max-w-[40ch]">Este trabajo consiste en crear
                    3 videos
        ...
        <div class="colum flex pt-20 px-64 pb-10 text-white gap-32 justify-center max-md:pt-16 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
            <div class="info_proyect max-w-[80ch]">
                <div class="info_secondary flex flex-col gap-6 sticky top-32">
                    ...
                    <div class="text text-[16px] leading-6 text-zinc-100 font-normal max-w-[64ch] max-md:text-xs">
        ...
        <div class="images pt-20 px-64 pb-10 text-white justify-center flex flex-col gap-10 max-md:pt-2 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-4">
            ...
            <div class="text max-w-[60ch] text-[16px] text-zinc-100 font-bold pb-6 max-md:text-xs">Muestra de cada uno de los videos por
                separado
                para apreciar los diferentes tipos de encargo para cada video.
            </div>

            <div class="grid grid-cols-2 grid-row-3 gap-6 max-md:grid-cols-1">
        ...
        <div class="trabajos flex pt-10 pl-40 pr-40 pb-20 text-zinc-100 flex-col gap-10 justify-center items-center  max-md:pt-12 max-md:pb-2 max-md:px-10 max-md:flex-col max-md:justify-center max-md:gap-10">
        ...
        <div class="foter bg-[#DC5051] p-10 flex text-white justify-between sticky top-0 max-md:p-6">
